...
class ConfigException : public EasyCheng::GEEKLAB::ScriptableObjects::ScriptingException
{
...
public:
    ...
    ConfigException(const wstring& msg, TextLocation where)
        : EasyCheng::GEEKLAB::ScriptableObjects::ScriptingException(EasyCheng::GEEKLAB::EASYGEN::ToLegacyString(EasyCheng::GEEKLAB::EASYGEN::ToUTF8(msg)))
    {
    ...
    {
        return TextLocation::CreateIssueMessage(locations, linePrefix.c_str(), kind(), EasyCheng::GEEKLAB::EASYGEN::ToFixedWStringFromMultiByte(what()).c_str());
    }
    // pretty-print this as an error message
    void /*ScriptingException::*/ PrintError(const std::wstring& linePrefix) const override
    {
        TextLocation::PrintIssue(locations, linePrefix.c_str(), kind(), EasyCheng::GEEKLAB::EASYGEN::ToFixedWStringFromMultiByte(what()).c_str());
    }
